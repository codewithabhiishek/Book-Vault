    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-md">
        ...
        <div className="brutal-border brutal-shadow-lg bg-white p-8">
          <h2 className="text-3xl font-heading mb-6 tracking-wide">SIGN IN</h2>
          ...
          <p className="font-mono text-sm text-center mt-8 text-muted-foreground uppercase">
            <Link to="/forgot-password" className="hover:text-brutal-teal hover:underline transition-colors">Forgot password?</Link>
          </p>
          <p className="font-mono text-sm text-center mt-3 text-muted-foreground uppercase">
            Don't have an account? <Link to="/register" className="font-bold text-foreground hover:text-brutal-teal hover:underline transition-colors ml-2">Register</Link>
          </p>
        </div>
      </div>
    </div>
